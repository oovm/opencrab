...
async function rustClippy() {
    await runCommand("cargo", ["clippy", "--workspace", "--all-targets", "--all-features", "--", "-D", "warnings"])
}

async function rustCheck() {
    await runCommand("cargo", ["check", "--workspace", "--all-targets", "--all-features"])
}
...
async function main() {
    log("blue", "\n╔══════════════════════════════════════════════════════════╗")
    log("blue", "║               OpenCrab Local CI Check Runner              ║")
    log("blue", "╚══════════════════════════════════════════════════════════╝\n")
